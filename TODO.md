...
- [x] Owner test (2026-09, PASSED): owner ran the deployed attempt 2 on strong backends (Gemma4-12B / Qwen3.6-35B-VL) and confirmed the result meets requirements — location analysis intact, deeper categories working, output concise.
